                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li> <a href="">Ekle</a> </li>                                        <li class="last">
                                            <a href="index.php/../"><img src="images/search_icon.png" alt="icon" /></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
...
<form action="create.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="">Adı :</label>
        <input placeholder="Adı" class="form-control"  type="text" name="Name" id="name">
    </div>
    <div class="form-group">
        <label for="">Fiyatı :</label>
        <input placeholder="Fiyatı" class="form-control"  type="text" name="Price" id="price">
    </div>
    <div class="form-group">
