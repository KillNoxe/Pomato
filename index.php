...
$sql = "SELECT phone.Name,phone.Image,phone.Price,marka.MarkaName,category.CategoryName
from phone
INNER JOIN marka
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li> <a href="ekle.php">Ekle</a> </li>                                        <li class="last">
            ...
            <div class="container">
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <div class="brand_box">
                        ...
                        <h3><strong class="red">'.$row["Price"].' TL</strong></h3>
                    </div>
                    </div>
                    ';
                    }
